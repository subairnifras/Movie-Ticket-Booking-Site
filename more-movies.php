...
<body>
  ...
  <header>
    ...
    <ul class="navbar">
      ...
      <li><a href="index.php#movies" class="home-active">Movies</a></li>
...
<section class="search-panel">
  ...
  <!-- More Movies Section -->
  <section class="movies" id="more-movies">
    <h2 class="heading">Hollywood Movies</h2>
